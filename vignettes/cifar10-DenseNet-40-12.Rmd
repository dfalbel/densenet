...
In this example we will train a DenseNet-40-12 to classify images from the CIFAR10
small images dataset. This stakes ~125s per epoch on a NVIDIA GEFORCE 1080 Ti
...
```{r}
model <- load_model_hdf5("inst/weights/cifar10-DenseNet-40-12.hdf5")
